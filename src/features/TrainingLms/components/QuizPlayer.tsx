        ...
        <CardContent sx={{ p: 3 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            {q.options.map(opt => {
              ...
              if (submitted) {
                if (isCorrect) borderColor = 'success.main';
                else if (isSelected && !isCorrect) borderColor = 'error.main';
            ...
            {allCorrect ? (
              ...
              <>
                ...
                <Typography variant="body2" color="text.secondary">
                  You got {questions.filter(q2 => answers[q2.id] === q2.correctOptionId).length} out of {questions.length} correct.
                </Typography>
